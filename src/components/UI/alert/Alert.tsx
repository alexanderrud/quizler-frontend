...
const Alert: React.FunctionComponent<AlertProperties> = ({alertType}) => {
    return (
        <div>
            <div className="flex w-96 rounded-lg ml-auto pr-5">
                <div className="bg-blue-500 py-4 px-6 rounded-l-lg flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" className="fill-current text-white" viewBox="0 0 16 16"
                         width="20" height="20">
